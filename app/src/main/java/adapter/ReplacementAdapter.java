...
public class ReplacementAdapter extends RecyclerView.Adapter<ReplacementAdapter.EmployeeViewHolder> {
    ...
    public ReplacementAdapter(List<Employee> post){
        this.post = post;
    }
    ...
    public EmployeeViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.replacement_cardview, viewGroup, false);
