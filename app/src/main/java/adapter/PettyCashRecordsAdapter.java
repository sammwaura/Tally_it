...
public class PettyCashRecordsAdapter extends RecyclerView.Adapter<PettyCashRecordsAdapter.ExpenseRecordsViewHolder> {
    ...
    public PettyCashRecordsAdapter(List<ExpenseRecords> post){
        this.post = post;
    }
    ...
    public ExpenseRecordsViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.petty_cash_records_cardview, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ExpenseRecordsViewHolder expenseRecordsViewHolder, int i) {
        ...
        expenseRecordsViewHolder.name.setText(String.format("%s. %s", s, post.get(i).name));
