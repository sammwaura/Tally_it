...
public class ViewEmployees extends AppCompatActivity implements CardIObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ViewEmployees.this.finish();
                Intent it = new Intent(ViewEmployees.this, AddEmployees.class);
                it.putExtra("type", "");
                startActivity(it);
            }
        });
    ...
    private void getAllEmployees() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_employee,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewEmployees.this);
    ...
    public void onCardClicked(final int pos, String id, String name, String phone, String password) {
        ...
        dialogBuilder = NiftyDialogBuilder.getInstance(ViewEmployees.this);
        dialogBuilder
                ...
                .setCustomView(R.layout.dialog_edit_employee, ViewEmployees.this)//def gone//def gone
    ...
    public void refreshActivity() {
        this.finish();
        Intent it = new Intent(ViewEmployees.this, ViewEmployees.class);
        it.putExtra("type", "");
        startActivity(it);
    }
