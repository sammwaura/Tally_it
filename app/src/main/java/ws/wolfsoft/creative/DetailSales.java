...
public class DetailSales extends AppCompatActivity {

    String stock_id,stock_name,frequency;
    private SharedPreferences credentialsSharedPreferences;
    public List<beans.DetailsSales> detailSales;
    DetailsSalesAdapter detailsSalesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllDetailSale(stock_id,stock_name);
    }

    private void getAllDetailSale(final String stock_id,final String stock_name) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_details_sales,
                            ...
                            try {
                                ...
                                if(posts.length() >0)
                                {
                                    for (int i = 0; i < posts.length(); i++) {
                                        ...
                                        String stock_date = row.getString("stock_date");

                                        detailSales.add(new DetailsSales(sales_id,stock_id,stock_name,price,employee_name,sale_type,date,quantity,metric,stock_date));
                                    }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DetailSales.this);
    ...
    private void initializeData() {
        detailsSalesAdapter = new DetailsSalesAdapter(detailSales);
        rv.setAdapter(detailsSalesAdapter);
