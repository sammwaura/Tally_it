...
import static ws.wolfsoft.creative.Constants.save_banking;
import static ws.wolfsoft.creative.Constants.save_creditor;

public class AddBankers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bankers);
                    ...
                    if(selectedCategory.equals("Specific Date"))
                    {
                        ...
                        creditor_date.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                // date picker dialog
                                picker = new DatePickerDialog(AddBankers.this,
                                        new DatePickerDialog.OnDateSetListener() {
                                            @Override
                                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                                selDate = dayOfMonth + "-" + (monthOfYear + 1) + "-" + year;
                                                Toast.makeText(AddBankers.this,selDate,Toast.LENGTH_LONG).show();
        ...
        findViewById(R.id.view).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(AddBankers.this, ViewBanking.class);
        ...
        findViewById(R.id.next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(AddBankers.this, Home.class);
                startActivity(it);
            }
        });
        ...
        findViewById(R.id.previous).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(AddBankers.this, AddExpenses.class);
                it.putExtra("type", "");
                startActivity(it);
            }
        });
    ...
    private void addCreditor() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, save_banking,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        System.out.println("sssssssssssssssssssssssssssssssssssss " + s);
                        Toast.makeText(getApplicationContext(), "Saved "+s+" Banking", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AddBankers.this);
