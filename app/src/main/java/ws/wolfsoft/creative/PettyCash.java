...
import adapter.PettyCashRecordsAdapter;
...
import static ws.wolfsoft.creative.Constants.get_petty_cash;

public class PettyCash extends AppCompatActivity  implements ExpenseRecordsIObserver {

    private Spinner spinner;
    private SharedPreferences credentialsSharedPreferences;
    public List<beans.ExpenseRecords> expenseRecords;
    PettyCashRecordsAdapter expenseRecordsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PettyCash.this.finish();
                Intent it = new Intent(PettyCash.this, Home.class);
                startActivity(it);
            }
        });
    ...
    private void getAllExpenseRecords() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_petty_cash,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PettyCash.this);
    ...
    private void initializeData() {
        expenseRecordsAdapter = new PettyCashRecordsAdapter(expenseRecords);
    ...
    public void onCardClicked(int pos, String name) {
        ...
        /*Intent it = new Intent(PettyCash.this, DetailExpense.class);
