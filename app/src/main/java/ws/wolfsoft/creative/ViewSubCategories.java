...
public class ViewSubCategories extends AppCompatActivity implements SubCategoryAdapter.AdapterListener, CategoryIObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_sub_categories);
        ...
        System.out.println("categoryIdcategoryIdcategoryId "+categoryId);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ViewSubCategories.this.finish();
                Intent it = new Intent(ViewSubCategories.this, AddCategories.class);
                it.putExtra("type", "");
                startActivity(it);
            }
        });
        ...
        findViewById(R.id.fab_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(ViewSubCategories.this, AddSubCategory.class);
    ...
    String oldCategory="";
    private void getAllCategorySpinner(final Spinner spinnerTypeCat, final List<Category> categorySpinner, final int pos) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_selected_category,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewSubCategories.this);
    ...
    private void getAllCategory() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, view_sub_categories,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                            ...
                            try {
                                ...
                                if(posts.length() >0)
                                {
                                    for (int i = 0; i < posts.length(); i++) {
                                        ...
                                        String category_id = row.getString("sub_category_id");
                                        String name = row.getString("name");
    ...
    public void refreshActivity() {
        this.finish();
        Intent it = new Intent(ViewSubCategories.this, ViewSubCategories.class);
        it.putExtra("type", "");
        startActivity(it);
    }
}
