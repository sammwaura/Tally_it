...
import static ws.wolfsoft.creative.Constants.get_banks;
import static ws.wolfsoft.creative.Constants.get_creditors;

public class ViewBanking extends AppCompatActivity implements CreditorIObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_banking);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ViewBanking.this.finish();
                Intent it = new Intent(ViewBanking.this, AddBankers.class);
                it.putExtra("type", "");
                startActivity(it);
            }
        });
        ...
        creditor_number_head.setText(String.format("%s Bank(s)", Objects.requireNonNull(credentialsSharedPreferences.getString(creditor_number, "0"))));
    ...
    private void getAllCreditors() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_banks,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewBanking.this);
    ...
    public void onCardClicked(final int pos, String id, String name, String amount) {
        dialogBuilder = NiftyDialogBuilder.getInstance(ViewBanking.this);
        dialogBuilder
                .withTitle("Edit Banking")
                ...
                .setCustomView(R.layout.dialog_edit_banking, ViewBanking.this)//def gone//def gone
    ...
    public void refreshActivity() {
        this.finish();
        Intent it = new Intent(ViewBanking.this, ViewBanking.class);
        it.putExtra("type", "");
        startActivity(it);
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, edit_creditor,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(getApplicationContext(), "Edited Banking(s)", Toast.LENGTH_LONG).show();
                        refreshActivity();
                        initializeData();
                        dialogBuilder.dismiss();
                    }
