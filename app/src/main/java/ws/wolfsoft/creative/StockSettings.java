...
public class StockSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subsubCategory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(StockSettings.this, ViewSubSubCategories.class);
                it.putExtra("type", "is_settings");
                startActivity(it);
            }
        });
        ...
        business.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(StockSettings.this, ViewStock2.class);
                it.putExtra("type", "is_settings");
                startActivity(it);
            }
        });
        ...
        employee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(StockSettings.this, ViewCategories.class);
                it.putExtra("type", "is_settings");
                startActivity(it);
            }
        });
        ...
        stock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(StockSettings.this, ViewSubCategories.class);
                it.putExtra("type", "is_settings");
                startActivity(it);
            }
        });
