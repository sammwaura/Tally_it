...
import static ws.wolfsoft.creative.Constants.get_stock2;
import static ws.wolfsoft.creative.Constants.get_sub_categories;

public  class ViewStock2 extends AppCompatActivity implements StockIObserver, StockAdapter.AdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab_add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(ViewStock2.this, AddStock.class);
        ...
        if(getIntent().getExtras().getString("type").equals("is_drawer"))
        {
    ...
    private void getAllStock() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_stock2,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewStock2.this);
    ...
    public void onCardClicked(final int pos, String name) {
        ...
        dialogBuilder = NiftyDialogBuilder.getInstance(ViewStock2.this);
        dialogBuilder
                ...
                .setCustomView(R.layout.dialog_edit_stock, ViewStock2.this)//def gone//def gone
        ...
        stock_name.setText(stock.get(pos).name);
    ...
    public void refreshActivity() {
        this.finish();
        Intent it = new Intent(ViewStock2.this, ViewStock2.class);
        it.putExtra("type", "");
        startActivity(it);
    }
