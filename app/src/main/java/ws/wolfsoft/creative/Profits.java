...
import static ws.wolfsoft.creative.Constants.get_profits;
import static ws.wolfsoft.creative.Constants.get_sales;

public class Profits extends AppCompatActivity  implements ProfitIObserver,SlyCalendarDialog.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Profits.this.finish();
                Intent it = new Intent(Profits.this, Home.class);
                startActivity(it);
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(selectedCategory.equals("Specify Date"))
                {
                    ...
                    // date picker dialog
                    picker = new DatePickerDialog(Profits.this,
                            new DatePickerDialog.OnDateSetListener() {
                                @Override
                                public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                    selDate = dayOfMonth + "-" + (monthOfYear + 1) + "-" + year;
                                    Toast.makeText(Profits.this,selDate,Toast.LENGTH_LONG).show();
                                    getAllProfits();
                                }
                            }, year, month, day);
                    picker.show();
    ...
    private void getAllProfits() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_profits,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Profits.this);
    ...
    public void onCardClicked(int pos, String name) {
        ...
        Intent it = new Intent(Profits.this, DetailProfits.class);
        it.putExtra("stock_id", profits.get(pos).stock_id);
        it.putExtra("stock_name", profits.get(pos).name);
