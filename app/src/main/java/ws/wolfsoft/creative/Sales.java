...
public class Sales extends AppCompatActivity  implements SalesIObserver,SlyCalendarDialog.Callback {
    ...
    TextView overall_number_head,cash_sales,debt_sales;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cash_sales =  findViewById(R.id.cash_sales);
        debt_sales =  findViewById(R.id.debt_sales);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Sales.this.finish();
                Intent it = new Intent(Sales.this, Home.class);
                startActivity(it);
            }
        });
                    ...
                    picker = new DatePickerDialog(Sales.this,
                            new DatePickerDialog.OnDateSetListener() {
                                ...
                                public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                    ...
                                    Toast.makeText(Sales.this,selDate,Toast.LENGTH_LONG).show();
                                    getAllSales();
                                }
                            }, year, month, day);
                    picker.show();
    ...
    private void getAllSales(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_sales,
                        ...
                        if(s!=null)
                        {
                            ...
                            try {
                                ...
                                if(posts.length() >0)
                                {
                                    ...
                                    cash_sales.setText(max_price);
                                    debt_sales.setText(min_price);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Sales.this);
    ...
    public void onCardClicked(int pos, String name) {
        ...
        Intent it = new Intent(Sales.this, DetailSales.class);
