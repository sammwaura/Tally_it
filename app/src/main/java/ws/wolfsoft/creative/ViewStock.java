...
public class ViewStock extends AppCompatActivity implements StockIObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab_add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(ViewStock.this, AddStock.class);
    ...
    private void getAllStock(final String categoryId) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViewStock.this);
    ...
    public void refreshActivity() {
        this.finish();
        Intent it = new Intent(ViewStock.this, ViewStock.class);
